...
def msgSurface(text):
    ...
    typTextSurf, typTextRect = makeTextObjs('Antonio Enriquez', smallText)
    typTextRect.center =  surfaceWidth / 2, ((surfaceHeight / 2) + 100)
    surface.blit(typTextSurf, typTextRect)

    typTextSurf, typTextRect = makeTextObjs('Naiky Yunetsy Isidro', smallText)
    typTextRect.center =  surfaceWidth / 2, ((surfaceHeight / 2) + 150)
    surface.blit(typTextSurf, typTextRect)

    typTextSurf, typTextRect = makeTextObjs('Juana Gutierrez', smallText)
